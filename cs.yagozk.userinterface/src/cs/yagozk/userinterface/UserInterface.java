		...
		if ( e.getSource() == testFrame.getAddButton() ) {
			if ( bigInt1 != null && bigInt2 != null ) {
				if ( inputLang1 == "eng")
					...
					testFrame.setResultField( calculator.translateToTr( calculator.add(bigInt1, bigInt2)));
			}
		}
		// SUBSTRACT
		...
		// MULTIPLY
			...
			if ( bigInt1 != null && bigInt2 != null ) {
				if ( inputLang1 == "eng")
					...
					testFrame.setResultField( calculator.translateToTr( calculator.mul(bigInt1, bigInt2)));
		...
		// DIVIDE
			...
			if ( bigInt1 != null && bigInt2 != null ) {
				...
				if ( inputLang1 == "eng" )
					...
					testFrame.setResultField( calculator.translateToTr( calculator.div(bigInt1, bigInt2)));
			}
		}
